...
# ---------------- RESULTS ----------------
    ...
    <div style="display: flex; align-items: center; margin: 20px 0;">
        <span style="color: #FFA726; font-weight: bold; min-width: 100px;">€{low_price:,.0f}</span>
        <div style="flex-grow: 1; height: 30px; background: linear-gradient(to right, #FFA726, #1E88E5, #66BB6A); margin: 0 15px; border-radius: 15px;"></div>
        <span style="color: #66BB6A; font-weight: bold; min-width: 100px; text-align: right;">€{high_price:,.0f}</span>
    </div>
